...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		// Felucca removed from these lists, to restore simply add Felucca to the array
		public static readonly PMList[] UORLists = {Trammel};
		public static readonly PMList[] UORListsYoung = {Trammel};
		public static readonly PMList[] LBRLists = {Felucca, Trammel, Ilshenar};
		public static readonly PMList[] LBRListsYoung = {Trammel, Ilshenar};
		public static readonly PMList[] AOSLists = {Felucca, Trammel, Ilshenar, Malas};
		public static readonly PMList[] AOSListsYoung = {Trammel, Ilshenar, Malas};
		public static readonly PMList[] SELists = {Felucca, Trammel, Ilshenar, Malas, Tokuno};
		public static readonly PMList[] SEListsYoung = {Trammel, Ilshenar, Malas, Tokuno};
		public static readonly PMList[] SALists = {Felucca, Trammel, Ilshenar, Malas, Tokuno, TerMur};
