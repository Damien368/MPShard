...
namespace Server
{
    public class SkilllimPickGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            this.AddLabel(67, 41, 1153, @"Please select your 3 skills");
                ...
                case 1:
                    {
                        ...
                        {
                            m.SendGump(new SkilllimPickGump(m_SkillBall));
                            m.SendMessage(0, "Please get rid of {0} skills, you have exceeded the 3 skills that are allowed.", info.Switches.Length - switches);
                            break;
    ...
    public class SkillBall3 : Item
    {
            ...
            : base(0xE73)
        {
            Weight = 1.0;
            Hue = 105;
            Name = "a three GM limited skill ball";
            Movable = false;
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            {
                m.SendMessage("Please choose  your 3 skills to set to 100.");
