...
namespace Server.Multis
{
    public class DynamicDecay
    {
        ...
        static DynamicDecay()
        {
            ...
            Register(DecayLevel.LikeNew, TimeSpan.FromDays(6), TimeSpan.FromDays(7));
            Register(DecayLevel.Slightly, TimeSpan.FromDays(6), TimeSpan.FromDays(7));
            Register(DecayLevel.Somewhat, TimeSpan.FromDays(6), TimeSpan.FromDays(7));
            Register(DecayLevel.Fairly, TimeSpan.FromDays(6), TimeSpan.FromDays(7));
            Register(DecayLevel.Greatly, TimeSpan.FromDays(6), TimeSpan.FromDays(7));
